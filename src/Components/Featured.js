...
import housereal from '../Assets/ralph-ravi-kayden-mR1CIDduGLc-unsplash.jpg'
import house2 from '../Assets/spacejoy-RUvW1KGD9a4-unsplash.jpg'
...
export default function Featured() {
  return (
    <div className='featured'>
        ...
        <p className='f-sub'>Selected Listings y City ,Sate & Zip based on views</p>
